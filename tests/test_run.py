...
# Since the run script doesn't have a .py extension, we'll test it by executing it directly
# We don't need to import the main module functions since we're testing via subprocess
...
class TestRun(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_csv_content = """https://github.com/test/code,https://huggingface.co/datasets/test,https://huggingface.co/google-bert/bert-base-uncased
...
,,https://huggingface.co/openai/whisper-tiny/tree/main"""
    ...
    def test_run_script_with_csv_file(self):
    ...
    def test_run_script_file_not_found(self):
        ...
        self.assertIn("Error: File 'non_existent_file.txt' not found", result.stderr)

    def test_run_script_empty_file(self):
    ...
    def test_run_script_only_github_urls(self):
    ...
    def test_run_script_no_args(self):
    ...
    def test_csv_parsing_edge_cases(self):
        ...
        edge_case_content = """https://github.com/test,https://huggingface.co/datasets/test,https://huggingface.co/model1
,,
